...
export class TipTopDBService {
  ...
  async getCurrencies() {
    try {
      const response = await axios.get(
        `${this.baseUrl}/api/v1/db/data/v1/TipTop/Currency`,
        {
          headers: {
  ...
  async updateCurrency(
    ...
    try {
      ...
      const response = await axios.patch(
        `${this.baseUrl}/api/v1/db/data/v1/TipTop/Currency/${currency.Id}`,
        data,
        {
          headers: {
            'xc-token': this.apiKey,
  ...
  async getSettings() {
    try {
      const response = await axios.get(
        `${this.baseUrl}/api/v1/db/data/v1/TipTop/Settings`,
        {
          headers: {
            'xc-token': this.apiKey,
          },
  ...
  async getResources(page: number = 1, limit: number = 10) {
    try {
      const response = await axios.get(
        `${this.baseUrl}/api/v1/db/data/v1/TipTop/Resources`,
        {
          headers: {
            'xc-token': this.apiKey,
          },
  ...
  async getResource(id: string) {
    try {
      const response = await axios.get(
        `${this.baseUrl}/api/v1/db/data/v1/TipTop/Resources/${id}`,
        {
          headers: {
            'xc-token': this.apiKey,
          },
